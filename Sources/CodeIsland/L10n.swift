...
final class L10n: ObservableObject {
    ...
    private static let en: [String: String] = [
        ...
        "remote_commands_enable": "Allow remote commands",
        "remote_commands_desc": "Let the iPhone open/focus Mac sessions and answer approvals over the internet (CloudKit). Separate from conversations — OFF by default.",
    ...
    private static let zh: [String: String] = [
        ...
        "remote_commands_enable": "允许远程指令",
        "remote_commands_desc": "允许 iPhone 通过互联网（CloudKit）打开/聚焦 Mac 会话、答复审批。与对话开关相互独立，默认关闭。",
